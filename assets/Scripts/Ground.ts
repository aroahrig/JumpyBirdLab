...
export class Ground extends Component {
    ...
    update(deltaTime: number) {
        ...
        if(this.tempStartLocation1.x <= (0 - this.groundWidth1)){
            this.tempStartLocation1.x = this.ground3.position.x + (this.groundWidth1);
        }
        if(this.tempStartLocation2.x <= (0 - this.groundWidth2)){
            this.tempStartLocation2.x = this.ground1.position.x + (this.groundWidth2);
        }
        if(this.tempStartLocation3.x <= (0 - this.groundWidth3)){
            this.tempStartLocation3.x = this.ground2.position.x + (this.groundWidth3);
        }
